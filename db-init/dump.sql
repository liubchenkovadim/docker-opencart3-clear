...
--
-- Хост: db
-- Час створення: Вер 02 2025 р., 10:56
...
(1, 'Default', '', 1, '2025-09-02 10:55:39', '2025-09-02 10:55:39');
...
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2025-09-02 10:55:53'),
...
--
-- Структура таблиці `oc_customer_affiliate`
--
...
--
-- Структура таблиці `oc_customer_approval`
--
...
--
-- Структура таблиці `oc_extension_install`
--
...
--
-- Дамп даних таблиці `oc_extension_install`
--

INSERT INTO `oc_extension_install` (`extension_install_id`, `extension_download_id`, `filename`, `date_added`) VALUES
(1, 0, '[ocmod.net] localcopy_oc3x.ocmod.zip', '2025-09-02 10:56:10');

-- --------------------------------------------------------

--
-- Структура таблиці `oc_extension_path`
--
...
--
-- Структура таблиці `oc_googleshopping_category`
--
...
--
-- Структура таблиці `oc_googleshopping_product`
--
...
--
-- Структура таблиці `oc_googleshopping_product_status`
--
...
--
-- Структура таблиці `oc_googleshopping_product_target`
--
...
--
-- Структура таблиці `oc_googleshopping_target`
--
...
--
-- Структура таблиці `oc_order_shipment`
--
...
--
-- Дамп даних таблиці `oc_session`
--

INSERT INTO `oc_session` (`session_id`, `data`, `expire`) VALUES
('bc312c4dfd69d51a40bc363ee2', '{\"user_id\":\"1\",\"user_token\":\"jLDRjmoK6G4XY6nRxEs2ulfqlTMGow46\",\"install\":\"X00fAdRsub\"}', '2025-09-02 11:56:18');
...
(202, 0, 'config', 'config_email', 'adminasd@sds.ss', 0),
...
(203, 0, 'config', 'config_encryption', '', 0),
...
--
-- Структура таблиці `oc_shipping_courier`
--
...
--
-- Дамп даних таблиці `oc_shipping_courier`
--
...
--
-- Структура таблиці `oc_statistics`
--
...
--
-- Дамп даних таблиці `oc_statistics`
--
...
(1, 1, 'admin', 'cf93526ab9257efae66f94ec4c40eeeedb7b5db2', 'S0sDzSZOc', 'John', 'Doe', 'adminasd@sds.ss', '', '', '172.18.0.1', 1, '2025-09-02 10:55:39');
...
--
-- Індекси таблиці `oc_customer_affiliate`
--
ALTER TABLE `oc_customer_affiliate`
  ADD PRIMARY KEY (`customer_id`);

--
-- Індекси таблиці `oc_customer_approval`
--
...
--
-- Індекси таблиці `oc_extension_install`
--
ALTER TABLE `oc_extension_install`
  ADD PRIMARY KEY (`extension_install_id`);

--
-- Індекси таблиці `oc_extension_path`
--
...
--
-- Індекси таблиці `oc_googleshopping_category`
--
...
--
-- Індекси таблиці `oc_googleshopping_product`
--
...
--
-- Індекси таблиці `oc_order_shipment`
--
...
--
-- Індекси таблиці `oc_shipping_courier`
--
ALTER TABLE `oc_shipping_courier`
  ADD PRIMARY KEY (`shipping_courier_id`);

--
-- Індекси таблиці `oc_statistics`
--
...
--
-- AUTO_INCREMENT для таблиці `oc_customer_approval`
--
ALTER TABLE `oc_customer_approval`
...
--
-- AUTO_INCREMENT для таблиці `oc_extension_install`
--
ALTER TABLE `oc_extension_install`
  MODIFY `extension_install_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблиці `oc_extension_path`
--
ALTER TABLE `oc_extension_path`
...
--
-- AUTO_INCREMENT для таблиці `oc_googleshopping_product`
--
ALTER TABLE `oc_googleshopping_product`
...
--
-- AUTO_INCREMENT для таблиці `oc_order_shipment`
--
ALTER TABLE `oc_order_shipment`
...
--
-- AUTO_INCREMENT для таблиці `oc_seo_url`
--
ALTER TABLE `oc_seo_url`
...
--
-- AUTO_INCREMENT для таблиці `oc_statistics`
--
ALTER TABLE `oc_statistics`
